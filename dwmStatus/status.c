...
#define MEM_STR         "Free: %d%% Buffers: %d%% Cache: %ld%% "   // memory, takes (up to) 3 integers: free, buffers, and cache
//#define VOL_STR         "%d% Ü"           // volume when not muted  IMPORTANT! SEE NOTE IN README FOR AUDO INFO
//#define VOL_MUTE_STR    "Ü     Ô × Ü"   // volume when muted
#define BAT_STR         "Batt: %d%% "              // Battery, unplugged, above BATT_LOW%
#define BAT_LOW_STR     "Batt!!: %d%% "              // Battery, unplugged, below BATT_LOW% remaining
#define BAT_CHRG_STR    "Batt: %d%%C "              // Battery, when charging (plugged into AC)

#define DATE_TIME_STR   "%a %B %d, %I:%M %p"    // This is a strftime format string which is passed localtime
